...
// router.route('/')
//     .post(function (request, response) {
//         var rehabilitationPlan = new RehabilitationPlan.Model(request.body.rehabilitationPlan);
...
//     })
//     .get(function (request, response) {
//         RehabilitationPlan.Model.find(function (error, rehabilitationPlans) {
//             if (error) response.send(error);
...
//     .get(function (request, response) { 
//         RehabilitationPlan.Model.findById(request.params.rehabilitationPlan_id, function (error, rehabilitationPlan) {
//             if (error) {
...
//     })
//     .delete(function (request, response) {
//         RehabilitationPlan.Model.findByIdAndRemove(request.params.rehabilitationPlan_id,
//             function (error, deleted) {
//                 if (!error) {
